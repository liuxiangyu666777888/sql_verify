...
class Class(db.Model):
    ...
    teacher_id = Column(BIGINT, ForeignKey('User.id'), nullable=False)
...
class StudentClass(db.Model):
    ...
    student = db.relationship('User', foreign_keys=[student_id], backref='student_classes')
    class_ = db.relationship('Class', foreign_keys=[class_id], backref='student_classes')
...
class Article(db.Model):
    ...
    publish_time = Column(TIMESTAMP, nullable=False, server_default=text('CURRENT_TIMESTAMP'))
